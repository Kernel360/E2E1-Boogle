...
nohup java -jar $DEPLOY_JAR --spring.profiles.active=prod >> /home/ec2-user/e2e-boogle/deploylog/deploy.log 2>/home/ec2-user/e2e-boogle/deploylog/deploy_err.log &
